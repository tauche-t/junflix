...
import { getMovies, getTodayTv, getTopRated, getUpComing, IGetMoviesResult, IGetTvResult } from "../api";
import { makeImagePath } from "../utils";
import { AiOutlineRight, AiOutlineLeft } from 'react-icons/ai';
import Air from "../Components/Tv/Air";
...
function Tv() {
  ...
  const { data, isLoading } = useQuery<IGetTvResult>(["tv", "airing_today"], getTodayTv);
  ...
  const clickedMovie = bigMovieMatch?.params.tvId && data?.results.find(movie => movie.id+"" === bigMovieMatch.params.tvId);
    ...
    <>
      <Wrapper>
        ...
        <>
          ...
          <Slider>
            <h3 style={{ paddingLeft: "20px" }}>AiringToday</h3>
          ...
          {bigMovieMatch ?
            <AnimatePresence>
              <>
                ...
                <BigMovie layoutId={bigMovieMatch.params.tvId} style={{ top: scrollY.get() + 100 }}>
                  {clickedMovie && (
                    <>
